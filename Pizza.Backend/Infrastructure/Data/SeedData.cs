    ...
    public static class SeedData
    {
        public static void Initialize(IServiceProvider serviceProvider)
        {
            ...
            using (var context = new MainDbContext(mainDbContextOptions))
            {
                ...
                var sucursalesFromDb = context.Sucursales.ToList();
        ...
        private static List<Producto> GetProductosFromPdf()
        {
            ...
            {
                // Pizzas
                new Producto { Nombre = "Clásica Margarita", Descripcion = "Queso mozzarella, tomate y albahaca fresca", Precio = 120, Categoria = "Pizzas", Activo = true },
                new Producto { Nombre = "Mexicana", Descripcion = "Chorizo, jalapeño, cebolla y queso fundido", Precio = 140, Categoria = "Pizzas", Activo = true },
                new Producto { Nombre = "Hawaiana", Descripcion = "Jamón, piña y queso mozzarella", Precio = 135, Categoria = "Pizzas", Activo = true },
                new Producto { Nombre = "BBQ Lovers", Descripcion = "Pollo BBQ, cebolla morada y queso cheddar", Precio = 150, Categoria = "Pizzas", Activo = true },
                new Producto { Nombre = "Cuatro Quesos", Descripcion = "Mozzarella, azul, parmesano y gouda", Precio = 155, Categoria = "Pizzas", Activo = true },
                new Producto { Nombre = "Suprema", Descripcion = "Pepperoni, jamón, champiñones y aceitunas", Precio = 150, Categoria = "Pizzas", Activo = true },
                new Producto { Nombre = "Vegetariana", Descripcion = "Pimientos, cebolla, champiñones y elote", Precio = 130, Categoria = "Pizzas", Activo = true },
                new Producto { Nombre = "BBQ Pollo", Descripcion = "Pollo en salsa BBQ con cebolla morada", Precio = 145, Categoria = "Pizzas", Activo = true },
                new Producto { Nombre = "Carnívora", Descripcion = "Pepperoni, salchicha italiana, jamón y tocino", Precio = 160, Categoria = "Pizzas", Activo = true },
                new Producto { Nombre = "Pepperoni Lovers", Descripcion = "Extra pepperoni y queso fundido", Precio = 145, Categoria = "Pizzas", Activo = true },
                new Producto { Nombre = "Del Mar", Descripcion = "Atún, aceitunas, cebolla morada y orégano", Precio = 155, Categoria = "Pizzas", Activo = true },
                new Producto { Nombre = "Campestre", Descripcion = "Champiñones, espinaca, tocino y mozzarella", Precio = 150, Categoria = "Pizzas", Activo = true },
                new Producto { Nombre = "Italiana", Descripcion = "Jamón serrano, aceitunas y albahaca", Precio = 155, Categoria = "Pizzas", Activo = true },
                new Producto { Nombre = "Tropical", Descripcion = "Piña, jamón y queso manchego", Precio = 140, Categoria = "Pizzas", Activo = true },
                new Producto { Nombre = "Ranchera", Descripcion = "Chorizo, frijoles, cebolla y queso", Precio = 140, Categoria = "Pizzas", Activo = true },
                new Producto { Nombre = "Napolitana", Descripcion = "Tomate, albahaca y parmesano", Precio = 135, Categoria = "Pizzas", Activo = true },
                new Producto { Nombre = "Pollo Alfredo", Descripcion = "Pollo, salsa blanca y champiñones", Precio = 150, Categoria = "Pizzas", Activo = true },
                new Producto { Nombre = "Pepperoni Clásica", Descripcion = "Pepperoni y queso mozzarella", Precio = 130, Categoria = "Pizzas", Activo = true },
                new Producto { Nombre = "BBQ Deluxe", Descripcion = "Pollo BBQ, tocino y cebolla", Precio = 155, Categoria = "Pizzas", Activo = true },
                new Producto { Nombre = "Deluxe", Descripcion = "Pepperoni, jamón, tocino, pimientos", Precio = 160, Categoria = "Pizzas", Activo = true },

                // Snacks
                new Producto { Nombre = "Palitos de ajo", Descripcion = "Pan artesanal con ajo y mantequilla", Precio = 50, Categoria = "Snacks", Activo = true },
                new Producto { Nombre = "Papas gajo", Descripcion = "Crujientes con especias de la casa", Precio = 45, Categoria = "Snacks", Activo = true },
                new Producto { Nombre = "Dedos de queso", Descripcion = "Empanizados rellenos de mozzarella", Precio = 55, Categoria = "Snacks", Activo = true },
                new Producto { Nombre = "Aros de cebolla", Descripcion = "Crujientes con empanizado casero", Precio = 50, Categoria = "Snacks", Activo = true },
                new Producto { Nombre = "Nachos con guacamole", Descripcion = "Totopos con guacamole y queso fundido", Precio = 65, Categoria = "Snacks", Activo = true },
                new Producto { Nombre = "Nachos con queso", Descripcion = "Totopos con queso fundido", Precio = 60, Categoria = "Snacks", Activo = true },
                new Producto { Nombre = "Alitas BBQ", Descripcion = "6 piezas con salsa BBQ", Precio = 70, Categoria = "Snacks", Activo = true },
                new Producto { Nombre = "Papas fritas", Descripcion = "Corte delgado con sal de ajo", Precio = 45, Categoria = "Snacks", Activo = true },
                new Producto { Nombre = "Mini calzones", Descripcion = "Rellenos de pepperoni y queso", Precio = 60, Categoria = "Snacks", Activo = true },
                new Producto { Nombre = "Nachos supremos", Descripcion = "Con carne molida y queso fundido", Precio = 65, Categoria = "Snacks", Activo = true },
                new Producto { Nombre = "Alitas picantes", Descripcion = "6 piezas con salsa picante", Precio = 70, Categoria = "Snacks", Activo = true },

                // Bebidas
                new Producto { Nombre = "Refresco Coca-Cola", Descripcion = "355ml", Precio = 25, Categoria = "Bebidas", Activo = true },
                new Producto { Nombre = "Refresco Sprite", Descripcion = "355ml", Precio = 25, Categoria = "Bebidas", Activo = true },
                new Producto { Nombre = "Refresco Fanta Naranja", Descripcion = "355ml", Precio = 25, Categoria = "Bebidas", Activo = true },
                new Producto { Nombre = "Agua mineral Peñafiel", Descripcion = "600ml", Precio = 20, Categoria = "Bebidas", Activo = true },
                new Producto { Nombre = "Limonada natural", Descripcion = "500ml con rodajas de limón", Precio = 30, Categoria = "Bebidas", Activo = true },
                new Producto { Nombre = "Refresco Pepsi", Descripcion = "355ml", Precio = 25, Categoria = "Bebidas", Activo = true },
                new Producto { Nombre = "Refresco Mirinda", Descripcion = "355ml sabor naranja", Precio = 25, Categoria = "Bebidas", Activo = true },
                new Producto { Nombre = "Refresco 7Up", Descripcion = "355ml sabor lima-limón", Precio = 25, Categoria = "Bebidas", Activo = true },
                new Producto { Nombre = "Té helado limón", Descripcion = "500ml con hielo", Precio = 28, Categoria = "Bebidas", Activo = true },
                new Producto { Nombre = "Refresco Coca-Cola 600ml", Descripcion = "Botella grande", Precio = 30, Categoria = "Bebidas", Activo = true },
                new Producto { Nombre = "Cerveza artesanal Chiapaneca", Descripcion = "355ml tipo lager", Precio = 45, Categoria = "Bebidas", Activo = true },
                new Producto { Nombre = "Agua natural", Descripcion = "500ml", Precio = 18, Categoria = "Bebidas", Activo = true },
                new Producto { Nombre = "Jugo de mango", Descripcion = "400ml natural", Precio = 28, Categoria = "Bebidas", Activo = true },
                new Producto { Nombre = "Refresco Dr. Pepper", Descripcion = "355ml", Precio = 25, Categoria = "Bebidas", Activo = true },
                new Producto { Nombre = "Refresco Coca-Cola Light", Descripcion = "355ml", Precio = 25, Categoria = "Bebidas", Activo = true },
                new Producto { Nombre = "Té durazno", Descripcion = "500ml", Precio = 28, Categoria = "Bebidas", Activo = true },
                new Producto { Nombre = "Agua mineral", Descripcion = "600ml", Precio = 20, Categoria = "Bebidas", Activo = true },
                new Producto { Nombre = "Jugo de naranja", Descripcion = "400ml natural", Precio = 28, Categoria = "Bebidas", Activo = true },
                new Producto { Nombre = "Agua embotellada", Descripcion = "600ml", Precio = 18, Categoria = "Bebidas", Activo = true },
                new Producto { Nombre = "Té verde", Descripcion = "500ml frío", Precio = 30, Categoria = "Bebidas", Activo = true },
                new Producto { Nombre = "Refresco Fanta Fresa", Descripcion = "355ml", Precio = 25, Categoria = "Bebidas", Activo = true },
                new Producto { Nombre = "Refresco Manzanita", Descripcion = "355ml", Precio = 25, Categoria = "Bebidas", Activo = true },
                new Producto { Nombre = "Jugo natural de piña", Descripcion = "400ml", Precio = 30, Categoria = "Bebidas", Activo = true },
                new Producto { Nombre = "Refresco Fanta Uva", Descripcion = "355ml", Precio = 25, Categoria = "Bebidas", Activo = true },
                new Producto { Nombre = "Cerveza artesanal", Descripcion = "355ml", Precio = 45, Categoria = "Bebidas", Activo = true },

                // Extras
                new Producto { Nombre = "Aderezo ranch", Descripcion = "Cremoso con hierbas y ajo", Precio = 10, Categoria = "Extras", Activo = true },
                new Producto { Nombre = "Extra de queso", Descripcion = "Porción adicional de queso fundido", Precio = 15, Categoria = "Extras", Activo = true },
                new Producto { Nombre = "Orilla rellena", Descripcion = "Masa con queso derretido dentro", Precio = 20, Categoria = "Extras", Activo = true },
                new Producto { Nombre = "Salsa picante", Descripcion = "Salsa roja casera de chile seco", Precio = 10, Categoria = "Extras", Activo = true },
                new Producto { Nombre = "Aderezo BBQ", Descripcion = "Salsa dulce y ahumada", Precio = 12, Categoria = "Extras", Activo = true },
                new Producto { Nombre = "Extra de pepperoni", Descripcion = "Porción adicional de pepperoni", Precio = 15, Categoria = "Extras", Activo = true },
                new Producto { Nombre = "Extra de tocino", Descripcion = "Porción adicional de tocino crujiente", Precio = 15, Categoria = "Extras", Activo = true },
                new Producto { Nombre = "Doble salsa BBQ", Descripcion = "Porción doble de salsa BBQ", Precio = 10, Categoria = "Extras", Activo = true },
                new Producto { Nombre = "Salsa habanera", Descripcion = "Muy picante con chile habanero", Precio = 12, Categoria = "Extras", Activo = true },
                new Producto { Nombre = "Salsa especial", Descripcion = "De jitomate con hierbas finas", Precio = 10, Categoria = "Extras", Activo = true },
                new Producto { Nombre = "Extra de jamón", Descripcion = "Porción adicional de jamón ahumado", Precio = 15, Categoria = "Extras", Activo = true },
                new Producto { Nombre = "Aderezo de ajo", Descripcion = "Salsa cremosa con ajo y especias", Precio = 10, Categoria = "Extras", Activo = true },
                new Producto { Nombre = "Extra de salsa blanca", Descripcion = "Porción adicional de salsa Alfredo", Precio = 12, Categoria = "Extras", Activo = true },
                new Producto { Nombre = "Orilla rellena de queso", Descripcion = "Queso fundido dentro de la masa", Precio = 20, Categoria = "Extras", Activo = true },
                new Producto { Nombre = "Salsa BBQ", Descripcion = "Salsa ahumada de la casa", Precio = 12, Categoria = "Extras", Activo = true },
